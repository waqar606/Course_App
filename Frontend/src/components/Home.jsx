              ...
              <div key={course._id} className="p-4">
                <div className="relative flex-shrink-0 w-80 transition-transform duration-300 transform hover:scale-105">
                  <div className="bg-gray-900 rounded-lg overflow-hidden">
                    <img
                      className="h-32 w-full object-contain mt-2.5"
...
//                       Course Title
//                     </h2>
//                     <button className="mt-8 bg-orange-500 text-white py-2 px-4 rounded-full hover:bg-blue-500 duration-300">
//                       Enroll Now
//                     </button>
//                   </div>
//                 </div>
//               </div>
//             </div>
//             {/* Duplicate the block above for more cards */}
//           </div>
//         </section>
