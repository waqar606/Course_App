...
function Buy() {
  ...
  //     console.log("Payment info: ", paymentInfo);
  //     await axios
  //       .post(`http://localhost:1000/api/v1/order`, paymentInfo, {
  //         headers: {
  //           Authorization: `Bearer ${token}`,
  //         },
  //         withCredentials: true,
    ...
    <>
      {error ? (
        ...
        <div className="flex flex-col sm:flex-row my-40 container mx-auto">
          {/* showing the order detail */}
          <div className="w-full md:w-1/2 bg-white p-6 rounded-xl shadow-md space-y-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="text-blue-600 font-bold">{course.title}</p>
            </div>
          </div>

          {/* showing the card/payment input section */}
          ...
          <div className="w-full md:w-1/2 flex justify-center items-center">
            <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-sm">
              ...
              <div className="mb-4">
                ...
                {/* input box for taking the input number */}
