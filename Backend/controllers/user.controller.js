...
//password in 124421
  ...
  //if all four feild are valid, proceed with user creation
...
//purchases main courses hain tou dhik jayen ge
  ...
  export const purchases = async (req, res) => {
    ...
    try {
      ...
      //one user ke purchaese many courses
